...
<body>
    ...
    <table class="RoomTable">
        <tr>
            ...
            <td><button onclick="window.location.href='LuxuryHotel.php'"style="background-color:#8b7655; color:white;">Luxury Stay</button></td>
    ...
    <table class="ImageTable">
        <?php
            ...
            $query = "SELECT * FROM hotel_rooms WHERE category='Luxury Stay' LIMIT 6";
