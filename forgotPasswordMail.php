...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'bigbrewtarcan@gmail.com';
    $mail->Password   = 'urqy tojh mecu ldnt';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;


    $mail->setFrom($email, 'Big Brew Pinagbarilan');
    $mail->addAddress($email, $_SESSION['email_address']);
...
<head>
    ...
    <script>
        function Validate(){
          ...
          if(userInput == OTP){
                window.location.href = "forgotPasswordEnterNew.php";  
            }else{
            alert("Wrong OTP.");
          }
        }
...
<body>
    ...
    <div id="container">
        <div id="otp-container">
                ...
                <div class="resend">
                    <a href="">Didn't receive the OTP? <span>RESEND OTP</span></a>
                </div>
