...
<body>
    ...
    <table class="RoomTable">
        <tr>
            ...
            <td><button onclick="window.location.href='BusinessStay.php'"style="background-color:#8b7655; color:white;">Business Stay</button></td>
        </tr>
    </table>
    ...
    <table class="ImageTable">
        <?php
            ...
            $query = "SELECT * FROM hotel_rooms WHERE category='Business Stay' LIMIT 6";
